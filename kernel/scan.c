/****************************************************************************
** CFI wrapped code from reading C file 'scan__cfic_tmp_new__.c'
**
...
// decl: int (struct scanner_s *)
#define LORELIB_CFI_36(FP) LORELIB_CFI(36, FP)
...
static int mygetc(scanner *sc)
{
     ...
     return(LORELIB_CFI_36(sc->getchr)(sc));
}
