/****************************************************************************
** CFI wrapped code from reading C file 'redft00e-r2hc-pad__cfic_tmp_new__.c'
**
...
static void apply(const plan *ego_, R *I, R *O)
{
     ...
     for (iv = 0; iv < vl; ++iv, I += ivs, O += ovs) {
	  ...
	  /* copy n+1 real numbers (real parts of hc array) from buf to O */
	  {
	       ...
	       LORELIB_CFI_6(cldcpy->apply)((plan *) cldcpy, buf, O);
	  }
     }
...
{
     const P *ego = (const P *) ego_;
     LORELIB_CFI_27(p->print)(p, "(redft00e-r2hc-pad-%D%v%(%p%)%(%p%))", 
