/****************************************************************************
** CFI wrapped code from reading C file 'rodft00e-r2hc-pad__cfic_tmp_new__.c'
**
...
static void apply(const plan *ego_, R *I, R *O)
{
     ...
     for (iv = 0; iv < vl; ++iv, I += ivs, O += ovs) {
	  ...
	  /* copy n-1 real numbers (imag. parts of hc array) from buf to O */
	  {
	       ...
	       LORELIB_CFI_6(cldcpy->apply)((plan *) cldcpy, buf+2*n-1, O);
	  }
     }
...
{
     const P *ego = (const P *) ego_;
     LORELIB_CFI_27(p->print)(p, "(rodft00e-r2hc-pad-%D%v%(%p%)%(%p%))", 
