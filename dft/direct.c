/****************************************************************************
** CFI wrapped code from reading C file 'direct__cfic_tmp_new__.c'
**
...
static void print(const plan *ego_, printer *p)
{
     ...
     if (ego->slv->bufferedp)
	  LORELIB_CFI_27(p->print)(p, "(dft-directbuf/%D-%D%v \"%s\")", 
		   compute_batchsize(d->sz), d->sz, ego->vl, d->nam);
     else
	  LORELIB_CFI_27(p->print)(p, "(dft-direct-%D%v \"%s\")", d->sz, ego->vl, d->nam);
}
