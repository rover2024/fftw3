/****************************************************************************
** CFI wrapped code from reading C file 'rank-geq2__cfic_tmp_new__.c'
**
...
static void apply(const plan *ego_, R *ri, R *ii, R *ro, R *io)
{
     ...
     LORELIB_CFI_7(cld1->apply)(ego->cld1, ri, ii, ro, io);

     cld2 = (plan_dft *) ego->cld2;
     LORELIB_CFI_7(cld2->apply)(ego->cld2, ro, io, ro, io);
}
...
static void print(const plan *ego_, printer *p)
{
     ...
     LORELIB_CFI_27(p->print)(p, "(dft-rank>=2/%d%(%p%)%(%p%))",
