/****************************************************************************
** CFI wrapped code from reading C file 'dft-r2hc__cfic_tmp_new__.c'
**
...
static void apply(const plan *ego_, R *ri, R *ii, R *ro, R *io)
{
     ...
     { /* transform vector of real & imag parts: */
	  ...
	  LORELIB_CFI_6(cld->apply)((plan *) cld, ri + ego->ishift, ro + ego->oshift);
     }
...
{
     const P *ego = (const P *) ego_;
     LORELIB_CFI_27(p->print)(p, "(dft-r2hc-%D%(%p%))", ego->n, ego->cld);
}
