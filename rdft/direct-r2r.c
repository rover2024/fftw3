/****************************************************************************
** CFI wrapped code from reading C file 'direct-r2r__cfic_tmp_new__.c'
**
...
// decl: void (const double *, double *, long *, long *, long, long, long)
...
static void apply(const plan *ego_, R *I, R *O)
{
     ...
     LORELIB_CFI_4(ego->k)(I, O, ego->is, ego->os, ego->vl, ego->ivs, ego->ovs);
}
...
static void print(const plan *ego_, printer *p)
{
     ...
     LORELIB_CFI_27(p->print)(p, "(rdft-%s-direct-r2r-%D%v \"%s\")", 
