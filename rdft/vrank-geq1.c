/****************************************************************************
** CFI wrapped code from reading C file 'vrank-geq1__cfic_tmp_new__.c'
**
...
static void apply(const plan *ego_, R *I, R *O)
{
     ...
     for (i = 0; i < vl; ++i) {
          LORELIB_CFI_6(cldapply)(ego->cld, I + i * ivs, O + i * ovs);
     }
}
...
static void print(const plan *ego_, printer *p)
{
     ...
     LORELIB_CFI_27(p->print)(p, "(rdft-vrank>=1-x%D/%d%(%p%))",
